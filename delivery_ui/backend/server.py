...
def stopRobot():
    ...
    global _delivery_launch_process
    global _delivery_state
    global _delivery_weight
    global active_map_yaml
    global _latest_pose
    ...
    # Stop Delivery
    kill_process(_delivery_launch_process, "delivery")
    _delivery_launch_process = None
    _delivery_state = "IDLE"
    _delivery_weight = 0.0

    # Stop mission
    kill_process(mission_process, "mission")
